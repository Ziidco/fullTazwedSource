...
@Component({
  selector: 'app-site-services-inner',
  templateUrl: './site-services-inner.component.html',
  styleUrls: ['./site-services-inner.component.css']
})
export class SiteServicesInnerComponent implements OnInit {
  faPlus = faPlus;
  showPayFail = false;
  uuidValue: any;
  math = Math;
