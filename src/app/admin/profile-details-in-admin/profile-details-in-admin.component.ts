...
@Component({
  selector: 'app-profile-details-in-admin',
  templateUrl: './profile-details-in-admin.component.html',
  styleUrls: ['./profile-details-in-admin.component.css']
})
export class ProfileDetailsInAdminComponent implements OnInit {
